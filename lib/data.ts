...
export const projectsData = [
  {
    ...
    tags: ['Vue3.0', 'uni-app', 'Vite', 'Axios', 'Tailwind'],
    tags_en: ['Vue3.0', 'uni-app', 'Vite', 'Axios', 'Tailwind'],
    imageUrl: ejrImage,
    projectUrl: '',
    demoUrl: ''
  },
  {
    ...
    tags: ['Vue3.0', 'uni-app', 'Vite', 'Axios', '重构'],
    tags_en: ['Vue3.0', 'uni-app', 'Vite', 'Axios', 'Refactor'],
    imageUrl: fireImage,
    projectUrl: '',
    demoUrl: ''
  },
  {
    ...
    tags: ['React', 'React-Router', 'Antd', 'Echarts', 'Webpack', 'Axios'],
    tags_en: ['React', 'React-Router', 'Antd', 'Echarts', 'Webpack', 'Axios'],
  ...
  },
  {
    ...
    tags: ['React', 'Antd', 'Dva', 'Axios', 'Qiankun', 'ECharts'],
    tags_en: ['React', 'Antd', 'Dva', 'Axios', 'Qiankun', 'ECharts'],
    imageUrl: SMImage,
    projectUrl: '',
